...
export default function FaqsRow({ _class, data }: ParamType) {
  return (
    <Table.Tr
      key={data.question}
    ...
    >
      ...
      <Table.Td className="text-balance ">{data.question}</Table.Td>
      <Table.Td className="line-clamp-2 text-balance  ">{data.answer}</Table.Td>
