...
export default function Decisions() {
  ...
  return (
    <div className="p-5">
      ...
      {/* Control Elements  */}
      <ControlLayout
        button={<ControlLayoutButton label="إضافة قرار" clickHandler={open} />}
        ...
        <Table striped highlightOnHover className="text-center">
          <Table.Thead>
            <Table.Tr>
              ...
              <Table.Th className="text-center"> التصنيف</Table.Th>
              <Table.Th className="text-center">القرار</Table.Th>
              <Table.Th className="text-center">البرامج المشمولة</Table.Th>
              <Table.Th className="text-center">الرابط</Table.Th>
              <Table.Th className="text-center">الكلمات المرتبطة</Table.Th>
